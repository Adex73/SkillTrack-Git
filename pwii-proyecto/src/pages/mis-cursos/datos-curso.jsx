...
function DatosCurso() {
    ...
    const cargarEstructura = async (id) => {
        try {
            await fetch(`http://localhost:3000/contenido/${id}`, { method: "POST" });
            const res = await fetch(`http://localhost:3000/contenido/${id}`);
    ...
    const crearTema = async (index) => {
        ...
        try {
            const res = await fetch(`http://localhost:3000/contenido/${cursoId}/modulo/${index}`, {
                method: "POST",
    ...
    const guardarCambios = async () => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:3000/contenido/${cursoId}/modulo/${temaSeleccionado.modIndex}/tema/${temaSeleccionado.temaIndex}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
    ...
    const eliminarTema = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:3000/contenido/${cursoId}/modulo/${temaSeleccionado.modIndex}/tema/${temaSeleccionado.temaIndex}`, { method: "DELETE" });
            if (res.ok) {
